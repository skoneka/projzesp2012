...
public class MainActivity extends AppWidgetProvider {
	...
	static String[] opisy = { "opis1", "opis2", "opis3", "opis4", "akcaj5",
			"akcja6" };
	static String[] aktywnosci = { "kacja1", "akcja2", "akcja3", "4", "akcaj5",
			"akcja6" };
...
/*
    public static class UpdateService extends Service {
        ...
        public void onStart(Intent intent, int startId) {
          //process your click here
        	Log.d("diywidget", "start UpdateService");
        }
   ...
   */
		...
		if (c.moveToFirst()) {
			do {
				for (String column : DiyDbAdapter.COLUMNS) {
					...
					opisy[i] = c
							.getString(c
									.getColumnIndexOrThrow(DiyDbAdapter.KEY_DESCRIPTION));
					aktywnosci[i] = c.getString(c
							.getColumnIndexOrThrow(DiyDbAdapter.KEY_TITLE));
					// SSID_szukane =
	...
	public static PendingIntent buildButtonPendingIntentXXX(Context context,
			int i) {
		Intent intent = new Intent();
	...
	// @Override
	// public void run() {
	// remoteViews.setTextViewText(R.id.widget_textview1, "TIME = "
